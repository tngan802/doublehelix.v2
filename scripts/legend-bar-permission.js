$(function () {
    ...
    bar += '<li><span class="text-dark">ddc_admins</li>';
    bar += '<li><span class="text-dark">ddc_da_team_12</li>';
    bar += '<li><span class="text-dark">ddc_advertising</li>';
    bar += '<li><span class="text-dark">ddc_managers</li>';
    bar += '<li><span class="text-dark">ddc_dna_developers</li>';
    bar += '<li><span class="text-dark">ddc_sales</li>';
    bar += '<li><span class="text-dark">ddc_operations</li>';
    bar += '<li><span class="text-dark">ddc_operations_interns</li>';
    bar += '<li><span class="text-dark">ddc_operations_staff</li>';
    bar += '<li><span class="text-dark">ddc_production</li>';
    bar += '<li><span class="text-dark">ddc_production_dev</li>';
    bar += '<li><span class="text-dark">ddc_products</li>';
    bar += '</ul>';
