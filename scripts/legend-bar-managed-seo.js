$(function () {
    ...
    bar += '<li class="breadcrumb-item text-dark">Managed SEO</li>';
    bar += '<a class="breadcrumb-item text-primary" href="http://marketing.dealer.com/collateral/";>Link to Collateral</a></li>';
    bar += '</ol>';
    bar += '</nav>';
    bar += '<ul>';
    bar += '<p class="text-dark";>Here is some general information regarding Managed SEO. The information in the tabs might not be up to date, so please double check with the Collateral link for the most up to date information.</p>';
